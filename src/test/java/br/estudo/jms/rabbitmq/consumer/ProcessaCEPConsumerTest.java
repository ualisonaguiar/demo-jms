...
//		final ResponseConsultaCEPDTO consultaCEP = processaCEPConsumer.consultaCEPWebService("70058900");
...
//		final ResponseConsultaCEPDTO consultaCEP = processaCEPConsumer.consultaCEPWebService("00000000");
//		assertEquals(consultaCEP.status(), HttpStatus.OK);
...
//		final boolean consultaCEP = processaCEPConsumer.consultaCEP("70058900");
//		assertTrue(consultaCEP);
//	}
//
//	@Test
//	public void consultaCEPError() throws URISyntaxException {
//		final boolean consultaCEP = processaCEPConsumer.consultaCEP("00000000");
